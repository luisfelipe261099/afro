...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden">
      <PadraoAfro id="afroHome" className="absolute inset-0 h-full w-full" />
      <div className="absolute inset-0 bg-carvao/78" />
      <div className="absolute inset-0 bg-[radial-gradient(60%_50%_at_50%_120%,rgba(212,160,23,0.18),transparent)]" />
